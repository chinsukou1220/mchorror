...
import com.example.client.gui.WarningScreen;
...
public class SsttaallkkeerrModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        net.fabricmc.fabric.api.blockrenderlayer.v1.BlockRenderLayerMap.INSTANCE.putBlock(
            com.example.SsttaallkkeerrMod.GHOST_BLOCK, 
        ...
        ClientPlayNetworking.registerGlobalReceiver(com.example.SsttaallkkeerrMod.RED_NIGHT_PACKET, (client, handler, buf, responseSender) -> {
