        ...
        if (this.phase == 1) {
            ...
            if (this.tickCount >= 200) {
                ...
                if (this.targetPlayer instanceof net.minecraft.server.level.ServerPlayer) {
                    com.mittel.ssttaallkkeerr.network.ModNetworking.sendShakeToPlayer((net.minecraft.server.level.ServerPlayer) this.targetPlayer, 1200, 3.0f);
                }
                ...
                level.playSound(null, owner.blockPosition(), com.mittel.ssttaallkkeerr.SsttaallkkeerrMod.SAKEBIGOE_HAJIME, net.minecraft.sounds.SoundSource.HOSTILE, 1.0F, 1.0F);
            ...
            if (phase2Ticks > 0 && phase2Ticks % 10 == 0) {
                level.playSound(null, owner.blockPosition(), com.mittel.ssttaallkkeerr.SsttaallkkeerrMod.SAKEBIGOE_OWARI, net.minecraft.sounds.SoundSource.HOSTILE, 1.0F, 1.0F);
            }
    ...
    private void endAction(HorrorSteveEntity owner, ServerLevel level) {
        ...
        if (this.targetPlayer != null) {
            ...
            if (this.targetPlayer instanceof net.minecraft.server.level.ServerPlayer sp) {
                ...
                sp.connection.send(new net.minecraft.network.protocol.game.ClientboundStopSoundPacket(com.mittel.ssttaallkkeerr.SsttaallkkeerrMod.SAKEBIGOE_HAJIME.getLocation(), net.minecraft.sounds.SoundSource.HOSTILE));
