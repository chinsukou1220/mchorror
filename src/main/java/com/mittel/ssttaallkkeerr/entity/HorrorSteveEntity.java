package com.mittel.ssttaallkkeerr.entity;
...
public class HorrorSteveEntity extends PathfinderMob {
    ...
    // --- デバッグ＆拡張用変数 ---
    public com.mittel.ssttaallkkeerr.entity.action.ActionController.ActionType forcedDebugAction = com.mittel.ssttaallkkeerr.entity.action.ActionController.ActionType.NONE;
