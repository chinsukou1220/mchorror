package com.mittel.ssttaallkkeerr.command;

import com.mittel.ssttaallkkeerr.entity.HorrorSteveEntity;
import com.mittel.ssttaallkkeerr.entity.action.ActionController;
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        dispatcher.register(Commands.literal("rednight")
            ...
            .executes(context -> {
                ...
                com.mittel.ssttaallkkeerr.world.RedNightState state = com.mittel.ssttaallkkeerr.world.RedNightState.get(level);
                state.currentProbability = Math.min(1.0f, state.currentProbability + 0.10f);
                state.weaknessLevel += 1;
                state.setDirty();
                
                com.mittel.ssttaallkkeerr.world.RedNightManager.startRedNight(level);
